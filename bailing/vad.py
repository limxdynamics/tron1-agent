...
class FunVAD(VAD):
    def __init__(self, config):
        ...
        model_path=config.get("model_dir","models/fsmn_vad")
...
if __name__=="__main__":
    ...
    chunk_size = 512 # ms
    model = AutoModel(model="models/fsmn_vad",disable_update=True)
    wav_file = f"models/fsmn_vad/example/vad_example.wav"
