...
from bailing.utils.utils import read_json_file
...
def auto_import_modules(package_name):
    ...
    logger.info(f"模块:f{package_path}")
    # 遍历包内的所有模块
    for _, module_name, _ in pkgutil.iter_modules(package_path):
        ...
        try:
            ...
            logger.error(f"模块 '{full_module_name}' 加载失败: {e}")
